...
(function (global, factory) {
  ...
  ItemDrag.prototype._finishMigration = function() {
    ...
    addClass$1(element, targetSettings.itemVisibleClass);
  ...
  ItemMigrate.prototype.start = function(targetGrid, position, container) {
    ...
    // Instantiate new animation controllers.
    // TODO: Instead, could we just modify the existing instances so there's
    // no unnecessary memory allocations?
    item._animate = new ItemAnimate(item, itemElement);
    item._animateChild = new ItemAnimate(item, item._child);
